...
// Declare global variables or use shared data management approaches to use data across your entire app with Singleton
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$12.7Bn", percentageChange: 25.90)
    let stat2 = StatisticModel(title: "Total Volume", value: "$1.23Tr")
    
    let coinDataProvider = CoinModel(
       id: "bitcoin",
       symbol: "btc",
       name: "Bitcoin",
